 ...
 */
final class Version20230316110658 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` CHANGE email email VARCHAR(180) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE roles roles TEXT NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE password password VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE firstname firstname VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE lastname lastname VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`');
    }
}
